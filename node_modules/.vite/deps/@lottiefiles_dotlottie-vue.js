...
var t0 = (h2, n, a) => n in h2 ? e0(h2, n, { enumerable: true, configurable: true, writable: true, value: a }) : h2[n] = a;
var m = (h2, n, a) => t0(h2, typeof n != "symbol" ? n + "" : n, a);
var n2 = class {
...
var R1 = class {
  constructor() {
    m(this, "_strategy");
    this._strategy = typeof requestAnimationFrame == "function" ? new n2() : new r2();
  }
  requestAnimationFrame(n) {
...
var k1 = new Uint8Array([80, 75, 3, 4]);
var q2 = ["v", "ip", "op", "layers", "fr", "w", "h"];
var i2 = "0.49.0";
var a2 = "@lottiefiles/dotlottie-web";
var Q2 = 0.75;
var X2 = 4;
var n0 = (() => {
  var h2 = typeof document < "u" ? document.currentScript?.src : void 0;
  return function(n = {}) {
    var a, s = n, v, C, B = new Promise((e, t) => {
      v = e, C = t;
    }), z = Object.assign({}, s), _1 = "./this.program", A = "", h22;
    typeof document < "u" && document.currentScript && (A = document.currentScript.src), h2 && (A = h2), A.startsWith("blob:") ? A = "" : A = A.substr(0, A.replace(/[?#].*/, "").lastIndexOf("/") + 1), h22 = async (e) => {
      if (e = await fetch(e, { credentials: "same-origin" }), e.ok) return e.arrayBuffer();
      throw Error(e.status + " : " + e.url);
    };
    var r3 = s.print || console.log.bind(console), Z = s.printErr || console.error.bind(console);
    Object.assign(s, z), z = null, s.thisProgram && (_1 = s.thisProgram);
    var g1 = s.wasmBinary, y1, b1 = false, D1, K, I, e1, r1, X, L, p2, f2;
    function v2() {
      var e = y1.buffer;
      s.HEAP8 = K = new Int8Array(e), s.HEAP16 = e1 = new Int16Array(e), s.HEAPU8 = I = new Uint8Array(e), s.HEAPU16 = r1 = new Uint16Array(e), s.HEAP32 = X = new Int32Array(e), s.HEAPU32 = L = new Uint32Array(e), s.HEAPF32 = p2 = new Float32Array(e), s.HEAPF64 = f2 = new Float64Array(e);
    }
    var m2 = [], _2 = [], g2 = [];
    function i3() {
    ...
    var Y = 0, i1 = null;
    function w1(e) {
      throw s.onAbort?.(e), e = "Aborted(" + e + ")", Z(e), b1 = true, e = new WebAssembly.RuntimeError(e + ". Build with -sASSERTIONS for more info."), C(e), e;
    }
    var y2 = (e) => e.startsWith("data:application/octet-stream;base64,"), W1;
    async function a3(e) {
      if (!g1) try {
        var t = await h22(e);
      ...
      if (e == W1 && g1) e = new Uint8Array(g1);
    ...
    async function o3(e, t) {
      try {
        ...
        Z(`failed to asynchronously prepare wasm: ${i}`), w1(i);
      }
    }
    async function s3(e) {
      var t = W1;
      if (!g1 && typeof WebAssembly.instantiateStreaming == "function" && !y2(t) && typeof fetch == "function") try {
    ...
    var U1 = (e) => {
    ...
    }, z1 = s.noExitRuntime || true, w2 = typeof TextDecoder < "u" ? new TextDecoder() : void 0, a1 = (e, t = 0, r = NaN) => {
      var i = t + r;
      for (r = t; e[r] && !(r >= i); ) ++r;
      ...
      for (i = ""; t < r; ) {
        ...
        if (o & 128) {
          var d = e[t++] & 63;
          if ((o & 224) == 192) i += String.fromCharCode((o & 31) << 6 | d);
          else {
            var l = e[t++] & 63;
            o = (o & 240) == 224 ? (o & 15) << 12 | d << 6 | l : (o & 7) << 18 | d << 12 | l << 6 | e[t++] & 63, 65536 > o ? i += String.fromCharCode(o) : (o -= 65536, i += String.fromCharCode(55296 | o >> 10, 56320 | o & 1023));
          }
    ...
    var d3 = () => {
      ...
      for (var o of e) {
        if (o === 0 || o === i) break;
        if (j22(o, i, r.Oa + 16)) return f1(o), t;
      }
      return f1(i), t;
    }, s1 = (e, t, r) => {
      var i = I;
    ...
    var t1 = {}, J = {}, C1 = {}, u1, Q = (e, t, r) => {
      function i(u) {
        if (u = r(u), u.length !== e.length) throw new u1("Mismatched type converter count");
        for (var c = 0; c < e.length; ++c) $(e[c], u[c]);
      }
      e.forEach((u) => C1[u] = t);
      var o = Array(t.length), d = [], l = 0;
      t.forEach((u, c) => {
        J.hasOwnProperty(u) ? o[c] = J[u] : (d.push(u), t1.hasOwnProperty(u) || (t1[u] = []), t1[u].push(() => {
          o[c] = J[u], ++l, l === d.length && i(o);
        }));
      }), d.length === 0 && i(o);
    }, C2, S = (e) => {
      for (var t = ""; I[e]; ) t += C2[I[e++]];
      return t;
    }, g;
    function l3(e, t, r = {}) {
      var i = t.name;
      ...
      J[e] = t, delete C1[e], t1.hasOwnProperty(e) && (t = t1[e], delete t1[e], t.forEach((o) => o()));
    }
    function $(e, t, r = {}) {
      return l3(e, t, r);
    }
    var N1 = (e) => {
      throw new g(e.Na.Qa.Pa.name + " instance already deleted");
    }, j1 = false, M2 = () => {
    }, E2 = (e, t, r) => t === r ? e : r.Ta === void 0 ? null : (e = E2(e, t, r.Ta), e === null ? null : r.nb(e)), P2 = {}, c3 = {}, h3 = (e, t) => {
      if (t === void 0) throw new g("ptr should not be undefined");
      for (; e.Ta; ) t = e.cb(t), e = e.Ta;
      return c3[t];
    }, M1 = (e, t) => {
      if (!t.Qa || !t.Oa) throw new u1("makeClassHandle requires ptr and ptrType");
      if (!!t.Ua != !!t.Sa) throw new u1("Both smartPtrType and smartPtr must be specified");
      return t.count = { value: 1 }, l1(Object.create(e, { Na: { value: t, writable: true } }));
    }, l1 = (e) => typeof FinalizationRegistry > "u" ? (l1 = (t) => t, e) : (j1 = new FinalizationRegistry((t) => {
      t = t.Na, --t.count.value, t.count.value === 0 && (t.Sa ? t.Ua.Xa(t.Sa) : t.Qa.Pa.Xa(t.Oa));
    }), l1 = (t) => {
      var r = t.Na;
      return r.Sa && j1.register(t, { Na: r }, t), t;
    }, M2 = (t) => {
      j1.unregister(t);
    }, l1(e));
    function E1() {
    }
    var c1 = (e, t) => Object.defineProperty(t, "name", { value: e }), I2 = (e, t, r) => {
      if (e[t].Ra === void 0) {
        var i = e[t];
        e[t] = function(...o) {
          if (!e[t].Ra.hasOwnProperty(o.length)) throw new g(`Function '${r}' called with an invalid number of arguments (${o.length}) - expects one of (${e[t].Ra})!`);
          return e[t].Ra[o.length].apply(this, o);
        }, e[t].Ra = [], e[t].Ra[i.$a] = i;
      }
    }, B1 = (e, t, r) => {
      if (s.hasOwnProperty(e)) {
        if (r === void 0 || s[e].Ra !== void 0 && s[e].Ra[r] !== void 0) throw new g(`Cannot register public name '${e}' twice`);
        if (I2(s, e, e), s[e].Ra.hasOwnProperty(r)) throw new g(`Cannot register multiple overloads of a function with the same number of arguments (${r})!`);
        s[e].Ra[r] = t;
      } else s[e] = t, s[e].$a = r;
    }, f3 = (e) => {
    ...
    function v3(e, t, r, i, o, d, l, u) {
      this.name = e, this.constructor = t, this.Za = r, this.Xa = i, this.Ta = o, this.pb = d, this.cb = l, this.nb = u, this.wb = [];
    }
    var H1 = (e, t, r) => {
      for (; t !== r; ) {
        if (!t.cb) throw new g(`Expected null or instance of ${r.name}, got an instance of ${t.name}`);
        e = t.cb(e), t = t.Ta;
      }
      return e;
    };
    function m3(e, t) {
      ...
      if (!t.Na) throw new g(`Cannot pass "${Y1(t)}" as a ${this.name}`);
      if (!t.Na.Oa) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      return H1(t.Na.Oa, t.Na.Qa.Pa, this.Pa);
    }
    function _3(e, t) {
      if (t === null) {
        if (this.gb) throw new g(`null is not a valid ${this.name}`);
        if (this.fb) {
          var r = this.hb();
          return e !== null && e.push(this.Xa, r), r;
        }
        return 0;
      }
      if (!t || !t.Na) throw new g(`Cannot pass "${Y1(t)}" as a ${this.name}`);
      if (!t.Na.Oa) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (!this.eb && t.Na.Qa.eb) throw new g(`Cannot convert argument of type ${t.Na.Ua ? t.Na.Ua.name : t.Na.Qa.name} to parameter type ${this.name}`);
      if (r = H1(t.Na.Oa, t.Na.Qa.Pa, this.Pa), this.fb) {
        if (t.Na.Sa === void 0) throw new g("Passing raw pointer to smart pointer is illegal");
        switch (this.Bb) {
          case 0:
            if (t.Na.Ua === this) r = t.Na.Sa;
            else throw new g(`Cannot convert argument of type ${t.Na.Ua ? t.Na.Ua.name : t.Na.Qa.name} to parameter type ${this.name}`);
            break;
          case 1:
            r = t.Na.Sa;
            break;
          case 2:
            if (t.Na.Ua === this) r = t.Na.Sa;
              ...
              var i = t.clone();
              r = this.xb(r, S1(() => i.delete())), e !== null && e.push(this.Xa, r);
            }
            break;
          default:
    ...
    function g3(e, t) {
      ...
      if (!t.Na) throw new g(`Cannot pass "${Y1(t)}" as a ${this.name}`);
      if (!t.Na.Oa) throw new g(`Cannot pass deleted object as a pointer of type ${this.name}`);
      if (t.Na.Qa.eb) throw new g(`Cannot convert argument of type ${t.Na.Qa.name} to parameter type ${this.name}`);
      return H1(t.Na.Oa, t.Na.Qa.Pa, this.Pa);
    }
    function h1(e, t, r, i, o, d, l, u, c, p, f) {
      this.name = e, this.Pa = t, this.gb = r, this.eb = i, this.fb = o, this.vb = d, this.Bb = l, this.lb = u, this.hb = c, this.xb = p, this.Xa = f, o || t.Ta !== void 0 ? this.toWireType = _3 : (this.toWireType = i ? m3 : g3, this.Wa = null);
    }
    var S2 = (e, t, r) => {
      if (!s.hasOwnProperty(e)) throw new u1("Replacing nonexistent public symbol");
      s[e].Ra !== void 0 && r !== void 0 ? s[e].Ra[r] = t : (s[e] = t, s[e].$a = r);
    }, T, y3 = (e, t, r = []) => (e.includes("j") ? (e = e.replace(/p/g, "i"), t = (0, s["dynCall_" + e])(t, ...r)) : t = T.get(t)(...r), t), b3 = (e, t) => (...r) => y3(e, t, r), k = (e, t) => {
      e = S(e);
      var r = e.includes("j") ? b3(e, t) : T.get(t);
      ...
      function r(d) {
        o[d] || J[d] || (C1[d] ? C1[d].forEach(r) : (i.push(d), o[d] = true));
      }
      var i = [], o = {};
      throw t.forEach(r), new T2(`${e}: ` + i.map(F2).join([", "]));
    }, V1 = (e, t) => {
      for (var r = [], i = 0; i < e; i++) r.push(L[t + 4 * i >> 2]);
      return r;
    };
    function w3(e) {
      for (var t = 1; t < e.length; ++t) if (e[t] !== null && e[t].Wa === void 0) return true;
      return false;
    }
    function q1(e, t, r, i, o) {
      var d = t.length;
      if (2 > d) throw new g("argTypes array size mismatch! Must at least get return value and 'this' types!");
      var l = t[1] !== null && r !== null, u = w3(t), c = t[0].name !== "void", p = d - 2, f = Array(p), _ = [], w = [];
      return c1(e, function(...W) {
        if (w.length = 0, _.length = l ? 2 : 1, _[0] = o, l) {
          var M = t[1].toWireType(w, this);
          _[1] = M;
        }
        for (var E = 0; E < p; ++E) f[E] = t[E + 2].toWireType(w, W[E]), _.push(f[E]);
        if (W = i(..._), u) $1(w);
        else for (E = l ? 1 : 2; E < t.length; E++) {
          var N = E === 1 ? M : f[E - 2];
          t[E].Wa !== null && t[E].Wa(N);
        }
        return M = c ? t[0].fromWireType(W) : void 0, M;
      });
    }
    var x2 = (e) => {
      e = e.trim();
      ...
      9 < e && --H[e + 1] === 0 && (H[e] = void 0, Q1.push(e));
    }, I1 = (e) => {
      ...
      switch (e) {
        ...
        case false:
          return 8;
        default:
          let t = Q1.pop() || H.length;
          return H[t] = e, H[t + 1] = 1, t;
      }
    }, R2 = { name: "emscripten::val", fromWireType: (e) => {
      var t = I1(e);
      return X1(e), t;
    }, toWireType: (e, t) => S1(t), Va: 8, readValueFromPointer: d1, Wa: null }, L3 = (e, t, r) => {
      switch (t) {
        case 1:
          return r ? function(i) {
            return this.fromWireType(K[i]);
          } : function(i) {
            return this.fromWireType(I[i]);
          };
        case 2:
          return r ? function(i) {
            return this.fromWireType(e1[i >> 1]);
          } : function(i) {
            return this.fromWireType(r1[i >> 1]);
          };
        case 4:
          return r ? function(i) {
            return this.fromWireType(X[i >> 2]);
          } : function(i) {
            return this.fromWireType(L[i >> 2]);
          };
        default:
      ...
      var r = J[e];
      if (r === void 0) throw e = `${t} has unknown type ${F2(e)}`, new g(e);
      return r;
    }, Y1 = (e) => {
      ...
      switch (t) {
        case 4:
          return function(r) {
            return this.fromWireType(p2[r >> 2]);
          };
        case 8:
          return function(r) {
      ...
      switch (t) {
        case 1:
          return r ? (i) => K[i] : (i) => I[i];
        case 2:
          return r ? (i) => e1[i >> 1] : (i) => r1[i >> 1];
        case 4:
          return r ? (i) => X[i >> 2] : (i) => L[i >> 2];
        default:
          throw new TypeError(`invalid integer width (${t}): ${e}`);
      }
    }, E3 = Object.assign({ optional: true }, R2), k2 = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, P3 = (e, t) => {
      for (var r = e >> 1, i = r + t / 2; !(r >= i) && r1[r]; ) ++r;
      if (r <<= 1, 32 < r - e && k2) return k2.decode(I.subarray(e, r));
      for (r = "", i = 0; !(i >= t / 2); ++i) {
        var o = e1[e + 2 * i >> 1];
        if (o == 0) break;
      ...
      for (var o = 0; o < r; ++o) e1[t >> 1] = e.charCodeAt(o), t += 2;
      return e1[t >> 1] = 0, t - i;
    }, S3 = (e) => 2 * e.length, T3 = (e, t) => {
      for (var r = 0, i = ""; !(r >= t / 4); ) {
        var o = X[e + 4 * r >> 2];
        if (o == 0) break;
      ...
      var i = [];
      return e = e.toWireType(i, r), i.length && (L[t >> 2] = S1(i)), e;
    }, G1 = [], R3 = (e) => {
      var t = G1.length;
      return G1.push(e), t;
    }, k3 = (e, t) => {
      for (var r = Array(e), i = 0; i < e; ++i) r[i] = T1(L[t + 4 * i >> 2], "parameter " + i);
      return r;
    }, A3 = Reflect.construct, p1 = {}, O2 = (e) => {
      if (!(e instanceof b22 || e == "unwind")) throw e;
    }, D2 = (e) => {
      throw D1 = e, z1 || 0 < J1 || (s.onExit?.(e), b1 = true), new b22(e);
    }, O3 = (e) => {
      if (!b1) try {
        if (e(), !(z1 || 0 < J1)) try {
          D1 = e = D1, D2(e);
      ...
      if (!K1) {
        var e = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: (typeof navigator == "object" && navigator.languages && navigator.languages[0] || "C").replace("-", "_") + ".UTF-8", _: _1 || "./this.program" }, t;
        for (t in Z1) Z1[t] === void 0 ? delete e[t] : e[t] = Z1[t];
        var r = [];
    ...
    u1 = s.InternalError = class extends Error {
      constructor(e) {
        super(e), this.name = "InternalError";
      }
    };
    for (var z2 = Array(256), F1 = 0; 256 > F1; ++F1) z2[F1] = String.fromCharCode(F1);
    C2 = z2, g = s.BindingError = class extends Error {
      constructor(e) {
        super(e), this.name = "BindingError";
      }
    }, Object.assign(E1.prototype, { isAliasOf: function(e) {
      if (!(this instanceof E1 && e instanceof E1)) return false;
      var t = this.Na.Qa.Pa, r = this.Na.Oa;
      e.Na = e.Na;
      var i = e.Na.Qa.Pa;
      for (e = e.Na.Oa; t.Ta; ) r = t.cb(r), t = t.Ta;
      for (; i.Ta; ) e = i.cb(e), i = i.Ta;
      return t === i && r === e;
    }, clone: function() {
      if (this.Na.Oa || N1(this), this.Na.bb) return this.Na.count.value += 1, this;
      var e = l1, t = Object, r = t.create, i = Object.getPrototypeOf(this), o = this.Na;
      return e = e(r.call(t, i, { Na: { value: { count: o.count, ab: o.ab, bb: o.bb, Oa: o.Oa, Qa: o.Qa, Sa: o.Sa, Ua: o.Ua } } })), e.Na.count.value += 1, e.Na.ab = false, e;
    }, delete() {
      if (this.Na.Oa || N1(this), this.Na.ab && !this.Na.bb) throw new g("Object already scheduled for deletion");
      M2(this);
      var e = this.Na;
      --e.count.value, e.count.value === 0 && (e.Sa ? e.Ua.Xa(e.Sa) : e.Qa.Pa.Xa(e.Oa)), this.Na.bb || (this.Na.Sa = void 0, this.Na.Oa = void 0);
    }, isDeleted: function() {
      return !this.Na.Oa;
    }, deleteLater: function() {
      if (this.Na.Oa || N1(this), this.Na.ab && !this.Na.bb) throw new g("Object already scheduled for deletion");
      return this.Na.ab = true, this;
    } }), Object.assign(h1.prototype, { qb(e) {
      return this.lb && (e = this.lb(e)), e;
    }, jb(e) {
      this.Xa?.(e);
    }, Va: 8, readValueFromPointer: d1, fromWireType: function(e) {
      function t() {
        return this.fb ? M1(this.Pa.Za, { Qa: this.vb, Oa: r, Ua: this, Sa: e }) : M1(this.Pa.Za, { Qa: this, Oa: e });
      }
      var r = this.qb(e);
      if (!r) return this.jb(e), null;
      var i = h3(this.Pa, r);
      if (i !== void 0) return i.Na.count.value === 0 ? (i.Na.Oa = r, i.Na.Sa = e, i.clone()) : (i = i.clone(), this.jb(e), i);
      if (i = this.Pa.pb(r), i = P2[i], !i) return t.call(this);
      i = this.eb ? i.mb : i.pointerType;
      var o = E2(r, this.Pa, i.Pa);
      return o === null ? t.call(this) : this.fb ? M1(i.Pa.Za, { Qa: i, Oa: o, Ua: this, Sa: e }) : M1(i.Pa.Za, { Qa: i, Oa: o });
    } }), T2 = s.UnboundTypeError = ((e, t) => {
      var r = c1(t, function(i) {
...
` + i.replace(/^Error(:[^\n]*)?\n/, ""));
    ...
    })(Error, "UnboundTypeError"), H.push(0, 1, void 0, 1, null, 1, true, 1, false, 1), s.count_emval_handles = () => H.length / 2 - 5 - Q1.length;
    var U3 = { c: (e, t, r, i) => w1(`Assertion failed: ${e ? a1(I, e) : ""}, at: ` + [t ? t ? a1(I, t) : "" : "unknown filename", r, i ? i ? a1(I, i) : "" : "unknown function"]), d: () => d3(), n: (e, t, r) => {
      var i = new L2(e);
      throw L[i.Oa + 16 >> 2] = 0, L[i.Oa + 4 >> 2] = t, L[i.Oa + 8 >> 2] = r, o1 = e, o1;
    }, e: (e) => {
      throw o1 || (o1 = e), o1;
    }, S: () => {
    }, P: () => {
      ...
      var t = L1[e];
      delete L1[e];
      var r = t.hb, i = t.Xa, o = t.kb, d = o.map((l) => l.tb).concat(o.map((l) => l.zb));
      Q([e], d, (l) => {
        var u = {};
        return o.forEach((c, p) => {
          var f = l[p], _ = c.rb, w = c.sb, W = l[p + o.length], M = c.yb, E = c.Ab;
          u[c.ob] = { read: (N) => f.fromWireType(_(w, N)), write: (N, v1) => {
            var U = [];
            M(E, N, W.toWireType(U, v1)), $1(U);
          } };
        }), [{ name: t.name, fromWireType: (c) => {
          var p = {}, f;
          for (f in u) p[f] = u[f].read(c);
          return i(c), p;
        }, toWireType: (c, p) => {
          for (var f in u) if (!(f in p)) throw new TypeError(`Missing field: "${f}"`);
          var _ = r();
          for (f in u) u[f].write(_, p[f]);
          return c !== null && c.push(i, _), _;
        }, Va: 8, readValueFromPointer: d1, Wa: i }];
      });
    }, H: () => {
    }, ea: (e, t, r, i) => {
      t = S(t), $(e, { name: t, fromWireType: function(o) {
        return !!o;
    ...
    }, u: (e, t, r, i, o, d, l, u, c, p, f, _, w) => {
      f = S(f), d = k(o, d), u && (u = k(l, u)), p && (p = k(c, p)), w = k(_, w);
      var W = f3(f);
      B1(W, function() {
        P1(`Cannot construct ${f} due to unbound types`, [i]);
      }), Q([e, t, r], i ? [i] : [], (M) => {
        if (M = M[0], i) var E = M.Pa, N = E.Za;
        else N = E1.prototype;
        M = c1(f, function(...t2) {
          if (Object.getPrototypeOf(this) !== v1) throw new g("Use 'new' to construct " + f);
          if (U.Ya === void 0) throw new g(f + " has no accessible constructor");
          var V2 = U.Ya[t2.length];
          if (V2 === void 0) throw new g(`Tried to invoke ctor of ${f} with invalid number of parameters (${t2.length}) - expected (${Object.keys(U.Ya).toString()}) parameters instead!`);
          return V2.apply(this, t2);
        });
        var v1 = Object.create(N, { constructor: { value: M } });
        M.prototype = v1;
        var U = new v3(f, M, v1, w, E, d, u, p);
        if (U.Ta) {
          var m1;
          (m1 = U.Ta).ib ?? (m1.ib = []), U.Ta.ib.push(U);
        }
        return E = new h1(f, U, true, false, false), m1 = new h1(f + "*", U, false, false, false), N = new h1(f + " const*", U, false, true, false), P2[e] = { pointerType: m1, mb: N }, S2(W, M), [E, m1, N];
      });
    }, t: (e, t, r, i, o, d) => {
      var l = V1(t, r);
      o = k(i, o), Q([], [e], (u) => {
        ...
        if (u.Pa.Ya === void 0 && (u.Pa.Ya = []), u.Pa.Ya[t - 1] !== void 0) throw new g(`Cannot register multiple constructors with identical number of parameters (${t - 1}) for class '${u.name}'! Overload resolution is currently only performed using the parameter count, not actual type info!`);
        return u.Pa.Ya[t - 1] = () => {
          P1(`Cannot construct ${u.name} due to unbound types`, l);
        }, Q([], l, (p) => (p.splice(1, 0, null), u.Pa.Ya[t - 1] = q1(c, p, null, o, d), [])), [];
      });
    }, h: (e, t, r, i, o, d, l, u) => {
      var c = V1(r, i);
      t = S(t), t = x2(t), d = k(o, d), Q([], [e], (p) => {
        function f() {
          P1(`Cannot call ${_} due to unbound types`, c);
        }
        p = p[0];
        var _ = `${p.name}.${t}`;
        t.startsWith("@@") && (t = Symbol[t.substring(2)]), u && p.Pa.wb.push(t);
        var w = p.Pa.Za, W = w[t];
        return W === void 0 || W.Ra === void 0 && W.className !== p.name && W.$a === r - 2 ? (f.$a = r - 2, f.className = p.name, w[t] = f) : (I2(w, t, _), w[t].Ra[r - 2] = f), Q([], c, (M) => (M = q1(_, M, p, d, l), w[t].Ra === void 0 ? (M.$a = r - 2, w[t] = M) : w[t].Ra[r - 2] = M, [])), [];
      });
    }, ca: (e) => $(e, R2), y: (e, t, r, i) => {
      function o() {
      }
      t = S(t), o.values = {}, $(e, { name: t, constructor: o, fromWireType: function(d) {
        return this.constructor.values[d];
      }, toWireType: (d, l) => l.value, Va: 8, readValueFromPointer: L3(t, r, i), Wa: null }), B1(t, o);
    }, l: (e, t, r) => {
      var i = T1(e, "enum");
      t = S(t), e = i.constructor, i = Object.create(i.constructor.prototype, { value: { value: r }, constructor: { value: c1(`${i.name}_${t}`, function() {
      }) } }), e.values[r] = i, e[t] = i;
    }, E: (e, t, r) => {
      t = S(t), $(e, { name: t, fromWireType: (i) => i, toWireType: (i, o) => o, Va: 8, readValueFromPointer: C3(t, r), Wa: null });
    }, v: (e, t, r, i, o, d) => {
      var l = V1(t, r);
      e = S(e), e = x2(e), o = k(i, o), B1(e, function() {
        P1(`Cannot call ${e} due to unbound types`, l);
      }, t - 1), Q([], l, (u) => (S2(e, q1(e, [u[0], null].concat(u.slice(1)), null, o, d), t - 1), []));
    }, p: (e, t, r, i, o) => {
      if (t = S(t), o === -1 && (o = 4294967295), o = (u) => u, i === 0) {
        var d = 32 - 8 * r;
        o = (u) => u << d >>> d;
      }
      var l = t.includes("unsigned") ? function(u, c) {
        return c >>> 0;
      } : function(u, c) {
        return c;
      };
      $(e, { name: t, fromWireType: o, toWireType: l, Va: 8, readValueFromPointer: M3(t, r, i !== 0), Wa: null });
    }, k: (e, t, r) => {
      function i(d) {
        return new o(K.buffer, L[d + 4 >> 2], L[d >> 2]);
      }
      var o = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][t];
      r = S(r), $(e, { name: r, fromWireType: i, Va: 8, readValueFromPointer: i }, { ub: true });
    }, x: (e) => {
      $(e, E3);
    }, ka: (e, t, r, i, o, d, l, u, c, p, f, _) => {
      r = S(r), d = k(o, d), u = k(l, u), p = k(c, p), _ = k(f, _), Q([e], [t], (w) => (w = w[0], [new h1(r, w.Pa, false, false, true, w, i, d, u, p, _)]));
    }, da: (e, t) => {
      t = S(t), $(e, { name: t, fromWireType: function(r) {
        for (var i = L[r >> 2], o = r + 4, d, l = o, u = 0; u <= i; ++u) {
          var c = o + u;
          (u == i || I[c] == 0) && (l = l ? a1(I, l, c - l) : "", d === void 0 ? d = l : (d += "\0", d += l), l = c + 1);
        }
        return V(r), d;
      }, toWireType: function(r, i) {
        i instanceof ArrayBuffer && (i = new Uint8Array(i));
        var o, d = typeof i == "string";
        if (!(d || i instanceof Uint8Array || i instanceof Uint8ClampedArray || i instanceof Int8Array)) throw new g("Cannot pass non-string to std::string");
        if (d) for (var l = o = 0; l < i.length; ++l) {
          var u = i.charCodeAt(l);
          127 >= u ? o++ : 2047 >= u ? o += 2 : 55296 <= u && 57343 >= u ? (o += 4, ++l) : o += 3;
        }
        else o = i.length;
        if (l = e2(4 + o + 1), u = l + 4, L[l >> 2] = o, d) s1(i, u, o + 1);
        else if (d) for (d = 0; d < o; ++d) {
          var c = i.charCodeAt(d);
          if (255 < c) throw V(u), new g("String has UTF-16 code units that do not fit in 8 bits");
          I[u + d] = c;
        }
        else for (d = 0; d < o; ++d) I[u + d] = i[d];
        return r !== null && r.push(V, l), l;
      }, Va: 8, readValueFromPointer: d1, Wa(r) {
        V(r);
      } });
    }, A: (e, t, r) => {
      if (r = S(r), t === 2) var i = P3, o = I3, d = S3, l = (u) => r1[u >> 1];
      else t === 4 && (i = T3, o = F3, d = x3, l = (u) => L[u >> 2]);
      $(e, { name: r, fromWireType: (u) => {
        for (var c = L[u >> 2], p, f = u + 4, _ = 0; _ <= c; ++_) {
          var w = u + 4 + _ * t;
          (_ == c || l(w) == 0) && (f = i(f, w - f), p === void 0 ? p = f : (p += "\0", p += f), f = w + t);
        }
        return V(u), p;
      }, toWireType: (u, c) => {
        if (typeof c != "string") throw new g(`Cannot pass non-string to C++ string type ${r}`);
        var p = d(c), f = e2(4 + p + t);
        return L[f >> 2] = p / t, o(c, f + 4, p + t), u !== null && u.push(V, f), f;
      }, Va: 8, readValueFromPointer: d1, Wa(u) {
        V(u);
      } });
    }, s: (e, t, r, i, o, d) => {
      L1[e] = { name: S(t), hb: k(r, i), Xa: k(o, d), kb: [] };
    }, m: (e, t, r, i, o, d, l, u, c, p) => {
      L1[e].kb.push({ ob: S(t), tb: r, rb: k(i, o), sb: d, zb: l, yb: k(u, c), Ab: p });
    }, fa: (e, t) => {
      t = S(t), $(e, { Cb: true, name: t, Va: 0, fromWireType: () => {
      }, toWireType: () => {
      } });
    }, N: () => {
      z1 = false, J1 = 0;
      ...
      throw 1 / 0;
    }, F: (e, t, r) => (e = I1(e), t = T1(t, "emval::as"), A2(t, r, e)), ia: (e, t, r, i) => (e = G1[e], t = I1(t), e(null, t, r, i)), L: X1, ha: (e, t, r) => {
      var i = k3(e, t), o = i.shift();
      e--;
      var d = Array(e);
      return t = `methodCaller<(${i.map((l) => l.name).join(", ")}) => ${o.name}>`, R3(c1(t, (l, u, c, p) => {
        for (var f = 0, _ = 0; _ < e; ++_) d[_] = i[_].readValueFromPointer(p + f), f += i[_].Va;
        return l = r === 1 ? A3(u, d) : u.apply(l, d), A2(o, c, l);
      }));
    }, ja: (e) => {
      9 < e && (H[e + 1] += 1);
    }, ga: (e) => {
      var t = I1(e);
      $1(t), X1(e);
    }, r: (e, t) => (e = T1(e, "_emval_take_value"), e = e.readValueFromPointer(t), S1(e)), J: (e, t) => {
      if (p1[e] && (clearTimeout(p1[e].id), delete p1[e]), !t) return 0;
      var r = setTimeout(() => {
        delete p1[e], O3(() => N2(e, performance.now()));
      }, t);
      return p1[e] = { id: r, Db: t }, 0;
    }, K: (e, t, r, i) => {
      var o = (/* @__PURE__ */ new Date()).getFullYear(), d = new Date(o, 0, 1).getTimezoneOffset();
      o = new Date(o, 6, 1).getTimezoneOffset(), L[e >> 2] = 60 * Math.max(d, o), X[t >> 2] = +(d != o), t = (l) => {
        var u = Math.abs(l);
        return `UTC${0 <= l ? "-" : "+"}${String(Math.floor(u / 60)).padStart(2, "0")}${String(u % 60).padStart(2, "0")}`;
      }, e = t(d), t = t(o), o < d ? (s1(e, r, 17), s1(t, i, 17)) : (s1(e, i, 17), s1(t, r, 17));
    }, ba: () => performance.now(), M: (e) => {
      var t = I.length;
      ...
      for (var r = 1; 4 >= r; r *= 2) {
        ...
        e: {
          i = (Math.min(2147483648, 65536 * Math.ceil(Math.max(e, i) / 65536)) - y1.buffer.byteLength + 65535) / 65536 | 0;
          try {
            y1.grow(i), v2();
            var o = 1;
            break e;
      ...
      var r = 0;
      return W2().forEach((i, o) => {
        var d = t + r;
        for (o = L[e + 4 * o >> 2] = d, d = 0; d < i.length; ++d) K[o++] = i.charCodeAt(d);
        K[o] = 0, r += i.length + 1;
      }), 0;
    }, Z: (e, t) => {
      var r = W2();
      L[e >> 2] = r.length;
      var i = 0;
      return r.forEach((o) => i += o.length + 1), L[t >> 2] = i, 0;
    }, V: () => 52, T: () => 52, B: (e, t, r, i) => {
      for (var o = 0, d = 0; d < r; d++) {
        var l = L[t >> 2], u = L[t + 4 >> 2];
        t += 8;
        for (var c = 0; c < u; c++) {
          var p = e, f = I[l + c], _ = D3[p];
          f === 0 || f === 10 ? ((p === 1 ? r3 : Z)(a1(_)), _.length = 0) : _.push(f);
        }
        o += u;
      }
      return L[i >> 2] = o, 0;
    }, $: G3, _: Z3, j: B3, i: Y3, g: X3, aa: $3, z: J3, C: Q3, D: V3, a: z3, b: N3, f: j3, o: q3, q: H3, G: K3, X: D2, O: (e, t) => (U2(I.subarray(e, e + t)), 0) }, y;
    (async function() {
      function e(i) {
        return y = i.exports, y1 = y.la, v2(), T = y.qa, _2.unshift(y.ma), Y--, s.monitorRunDependencies?.(Y), Y == 0 && i1 && (i = i1, i1 = null, i()), y;
      }
      Y++, s.monitorRunDependencies?.(Y);
      var t = { a: U3 };
      if (s.instantiateWasm) try {
        return s.instantiateWasm(t, e);
      } catch (i) {
        Z(`Module.instantiateWasm callback failed with error: ${i}`), C(i);
      }
      W1 ?? (W1 = y2("DotLottiePlayer.wasm") ? "DotLottiePlayer.wasm" : s.locateFile ? s.locateFile("DotLottiePlayer.wasm", A) : A + "DotLottiePlayer.wasm");
      try {
        var r = await s3(t);
        return e(r.instance), r;
      } catch (i) {
        C(i);
      }
    })();
    var e2 = (e) => (e2 = y.na)(e), $2 = (e) => ($2 = y.oa)(e), V = (e) => (V = y.pa)(e), N2 = (e, t) => (N2 = y.ra)(e, t), F = (e, t) => (F = y.sa)(e, t), f1 = (e) => (f1 = y.ta)(e), x = (e) => (x = y.ua)(e), R = () => (R = y.va)(), j22 = (e, t, r) => (j22 = y.wa)(e, t, r);
    s.dynCall_iijj = (e, t, r, i, o, d) => (s.dynCall_iijj = y.xa)(e, t, r, i, o, d), s.dynCall_vijj = (e, t, r, i, o, d) => (s.dynCall_vijj = y.ya)(e, t, r, i, o, d), s.dynCall_jiii = (e, t, r, i) => (s.dynCall_jiii = y.za)(e, t, r, i);
    var B2 = s.dynCall_vijjjj = (e, t, r, i, o, d, l, u, c, p) => (B2 = s.dynCall_vijjjj = y.Aa)(e, t, r, i, o, d, l, u, c, p);
    s.dynCall_jii = (e, t, r) => (s.dynCall_jii = y.Ba)(e, t, r), s.dynCall_vjii = (e, t, r, i, o) => (s.dynCall_vjii = y.Ca)(e, t, r, i, o), s.dynCall_vjfii = (e, t, r, i, o, d) => (s.dynCall_vjfii = y.Da)(e, t, r, i, o, d), s.dynCall_vjiii = (e, t, r, i, o, d) => (s.dynCall_vjiii = y.Ea)(e, t, r, i, o, d), s.dynCall_vj = (e, t, r) => (s.dynCall_vj = y.Fa)(e, t, r), s.dynCall_vjiiiii = (e, t, r, i, o, d, l, u) => (s.dynCall_vjiiiii = y.Ga)(e, t, r, i, o, d, l, u), s.dynCall_vjiffii = (e, t, r, i, o, d, l, u) => (s.dynCall_vjiffii = y.Ha)(e, t, r, i, o, d, l, u), s.dynCall_vjiiii = (e, t, r, i, o, d, l) => (s.dynCall_vjiiii = y.Ia)(e, t, r, i, o, d, l), s.dynCall_viijii = (e, t, r, i, o, d, l) => (s.dynCall_viijii = y.Ja)(e, t, r, i, o, d, l), s.dynCall_iiiiij = (e, t, r, i, o, d, l) => (s.dynCall_iiiiij = y.Ka)(e, t, r, i, o, d, l), s.dynCall_iiiiijj = (e, t, r, i, o, d, l, u, c) => (s.dynCall_iiiiijj = y.La)(e, t, r, i, o, d, l, u, c), s.dynCall_iiiiiijj = (e, t, r, i, o, d, l, u, c, p) => (s.dynCall_iiiiiijj = y.Ma)(e, t, r, i, o, d, l, u, c, p);
    function z3(e, t) {
      var r = R();
      try {
        T.get(e)(t);
      } catch (i) {
        if (x(r), i !== i + 0) throw i;
        F(1, 0);
      }
    }
    function $3(e, t, r, i, o) {
      var d = R();
      try {
        return T.get(e)(t, r, i, o);
      } catch (l) {
        if (x(d), l !== l + 0) throw l;
        F(1, 0);
      }
    }
    function N3(e, t, r) {
    ...
    function V3(e) {
      ...
      try {
        ...
        if (x(t), r !== r + 0) throw r;
        F(1, 0);
      }
    }
    function q3(e, t, r, i, o) {
      var d = R();
      try {
        T.get(e)(t, r, i, o);
      } catch (l) {
    ...
    function Q3(e, t, r, i, o, d, l, u) {
      var c = R();
      try {
        return T.get(e)(t, r, i, o, d, l, u);
      } catch (p) {
        if (x(c), p !== p + 0) throw p;
        F(1, 0);
      }
    }
    function X3(e, t, r, i) {
    ...
    function J3(e, t, r, i, o, d) {
      var l = R();
      try {
        return T.get(e)(t, r, i, o, d);
      } catch (u) {
        if (x(l), u !== u + 0) throw u;
        F(1, 0);
      }
    ...
    function K3(e, t, r, i, o, d, l, u, c, p) {
      var f = R();
      try {
        B2(e, t, r, i, o, d, l, u, c, p);
      } catch (_) {
        if (x(f), _ !== _ + 0) throw _;
        F(1, 0);
      }
    }
    var x1;
    ...
    function H2() {
      function e() {
        if (!x1 && (x1 = true, s.calledRun = true, !b1)) {
          if (U1(_2), v(s), s.onRuntimeInitialized?.(), s.postRun) for (typeof s.postRun == "function" && (s.postRun = [s.postRun]); s.postRun.length; ) {
      ...
      if (!(0 < Y)) {
        if (s.preRun) for (typeof s.preRun == "function" && (s.preRun = [s.preRun]); s.preRun.length; ) i3();
        U1(m2), 0 < Y || (s.setStatus ? (s.setStatus("Running..."), setTimeout(() => {
...
m(G, "_ModulePromise", null), m(G, "_wasmURL", `https://cdn.jsdelivr.net/npm/${a2}@${i2}/dist/dotlottie-player.wasm`);
var n1 = class {
  constructor() {
  ...
  addEventListener(n, a) {
    ...
    s || (s = /* @__PURE__ */ new Set(), this._eventListeners.set(n, s)), s.add(a);
  }
  removeEventListener(n, a) {
    let s = this._eventListeners.get(n);
    s && (a ? (s.delete(a), s.size === 0 && this._eventListeners.delete(n)) : this._eventListeners.delete(n));
  }
  dispatch(n) {
    this._eventListeners.get(n.type)?.forEach((s) => s(n));
  }
...
var O = class {
  static _initializeObserver() {
    ...
    let n = (a) => {
      a.forEach((s) => {
        let v = this._observedCanvases.get(s.target);
        v && (s.isIntersecting ? v.unfreeze() : v.freeze());
      });
    };
    this._observer = new IntersectionObserver(n, { threshold: 0 });
  }
  static observe(n, a) {
    this._initializeObserver(), !this._observedCanvases.has(n) && (this._observedCanvases.set(n, a), this._observer?.observe(n));
  }
  static unobserve(n) {
...
m(O, "_observer", null), m(O, "_observedCanvases", /* @__PURE__ */ new Map());
var D = class {
  static _initializeObserver() {
    if (this._observer) return;
    let n = (a) => {
      a.forEach((s) => {
        ...
        this._observedCanvases.set(s.target, [C, z]);
      });
    };
    this._observer = new ResizeObserver(n);
  }
  static observe(n, a) {
    this._initializeObserver(), !this._observedCanvases.has(n) && (this._observedCanvases.set(n, [a, 0]), this._observer?.observe(n));
  }
  static unobserve(n) {
    let a = this._observedCanvases.get(n);
    if (a) {
      let s = a[1];
      s && clearTimeout(s);
    }
    this._observer?.unobserve(n), this._observedCanvases.delete(n), !this._observedCanvases.size && this._observer && (this._observer.disconnect(), this._observer = null);
  }
};
m(D, "_observer", null), m(D, "_observedCanvases", /* @__PURE__ */ new Map());
function r0(h2) {
  return /^#([\da-f]{6}|[\da-f]{8})$/iu.test(h2);
}
function G2(h2) {
  if (!r0(h2)) return 0;
  let n = h2.replace("#", "");
...
function o2(h2) {
  if (h2.byteLength < 4) return false;
  let n = new Uint8Array(h2.slice(0, k1.byteLength));
  for (let a = 0; a < k1.length; a += 1) if (k1[a] !== n[a]) return false;
  return true;
}
function J2(h2) {
  return q2.every((n) => Object.prototype.hasOwnProperty.call(h2, n));
}
function s2(h2) {
  if (typeof h2 == "string") try {
    return J2(JSON.parse(h2));
  } catch {
    return false;
  }
  else return J2(h2);
...
function q() {
  return 1 + ((P ? window.devicePixelRatio : 1) - 1) * Q2;
}
function A1(h2) {
  let n = h2.getBoundingClientRect();
...
var d2 = (h2, n) => h2 === "reverse" ? n.Mode.Reverse : h2 === "bounce" ? n.Mode.Bounce : h2 === "reverse-bounce" ? n.Mode.ReverseBounce : n.Mode.Forward;
var i0 = (h2, n) => h2 === "contain" ? n.Fit.Contain : h2 === "cover" ? n.Fit.Cover : h2 === "fill" ? n.Fit.Fill : h2 === "fit-height" ? n.Fit.FitHeight : h2 === "fit-width" ? n.Fit.FitWidth : n.Fit.None;
var a0 = (h2, n) => {
  let a = new n.VectorFloat();
  return a.push_back(h2[0]), a.push_back(h2[1]), a;
};
var u2 = (h2, n) => {
  let a = new n.VectorFloat();
  return h2.length !== 2 || (a.push_back(h2[0]), a.push_back(h2[1])), a;
};
var l2 = (h2, n) => h2 ? { align: a0(h2.align ?? [0.5, 0.5], n), fit: i0(h2.fit ?? "contain", n) } : n.createDefaultLayout();
var b = class b2 {
  constructor(n) {
    m(this, "_canvas");
  ...
  async _fetchData(n) {
    let a = await fetch(n);
    if (!a.ok) throw new Error(`Failed to fetch animation data from URL: ${n}. ${a.status}: ${a.statusText}`);
    let s = await a.arrayBuffer();
    return o2(s) ? s : new TextDecoder().decode(s);
  }
  _loadFromData(n) {
    if (this._dotLottieCore === null) return;
    let a = this._canvas.width, s = this._canvas.height, v = false;
    if (typeof n == "string") {
      if (!s2(n)) {
        this._dispatchError("Invalid Lottie JSON string: The provided string does not conform to the Lottie JSON format.");
        return;
      }
      v = this._dotLottieCore.loadAnimationData(n, a, s);
  ...
  get layout() {
    ...
    if (n) return { align: [n.align.get(0), n.align.get(1)], fit: (() => {
      switch (n.fit) {
        case b2._wasmModule?.Fit.Contain:
          return "contain";
        case b2._wasmModule?.Fit.Cover:
          return "cover";
        case b2._wasmModule?.Fit.Fill:
          return "fill";
        case b2._wasmModule?.Fit.FitHeight:
          return "fit-height";
        case b2._wasmModule?.Fit.FitWidth:
          return "fit-width";
        case b2._wasmModule?.Fit.None:
          return "none";
        default:
          return "contain";
      }
  ...
  get mode() {
    ...
    return n === b2._wasmModule?.Mode.Reverse ? "reverse" : n === b2._wasmModule?.Mode.Bounce ? "bounce" : n === b2._wasmModule?.Mode.ReverseBounce ? "reverse-bounce" : "forward";
  }
  get isFrozen() {
  ...
  load(n) {
    this._dotLottieCore === null || b2._wasmModule === null || (this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), this._isFrozen = false, this._dotLottieCore.setConfig({ animationId: n.animationId ?? "", themeId: n.themeId ?? "", stateMachineId: "", autoplay: n.autoplay ?? false, backgroundColor: 0, loopAnimation: n.loop ?? false, mode: d2(n.mode ?? "forward", b2._wasmModule), segment: u2(n.segment ?? [], b2._wasmModule), speed: n.speed ?? 1, useFrameInterpolation: n.useFrameInterpolation ?? true, marker: n.marker ?? "", layout: l2(n.layout, b2._wasmModule) }), n.data ? this._loadFromData(n.data) : n.src && this._loadFromSrc(n.src), this.setBackgroundColor(n.backgroundColor ?? ""));
  }
  _render() {
    ...
    if (!this._context && "getContext" in this._canvas && typeof this._canvas.getContext == "function" && (this._context = this._canvas.getContext("2d")), this._dotLottieCore.render()) {
      if (this._context) {
        let a = this._dotLottieCore.buffer(), s = this._canvas.width * this._canvas.height * X2;
        if (a.byteLength !== s) return console.warn(`Buffer size mismatch: got ${a.byteLength}, expected ${s}`), false;
        let v = null, C = new Uint8ClampedArray(a, 0, a.byteLength);
        typeof ImageData > "u" ? (v = this._context.createImageData(this._canvas.width, this._canvas.height), v.data.set(C)) : v = new ImageData(C, this._canvas.width, this._canvas.height), this._context.putImageData(v, 0, 0);
      }
  ...
  setBackgroundColor(n) {
    this._dotLottieCore !== null && (P && this._canvas instanceof HTMLCanvasElement ? this._canvas.style.backgroundColor = n : this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), backgroundColor: G2(n) }), this._backgroundColor = n);
  }
  setLoop(n) {
  ...
  destroy() {
    this._animationFrameId !== null && (this._frameManager.cancelAnimationFrame(this._animationFrameId), this._animationFrameId = null), P && this._canvas instanceof HTMLCanvasElement && (O.unobserve(this._canvas), D.unobserve(this._canvas)), this._dotLottieCore?.delete(), this._dotLottieCore = null, this._context = null, this._eventManager.dispatch({ type: "destroy" }), this._eventManager.removeAllEventListeners(), this._cleanupStateMachineListeners();
  }
  freeze() {
  ...
  resize() {
    ...
    if (P && this._canvas instanceof HTMLCanvasElement) {
      let a = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, { height: s, width: v } = this._canvas.getBoundingClientRect();
      s !== 0 && v !== 0 && (this._canvas.width = v * a, this._canvas.height = s * a);
    }
    this._dotLottieCore.resize(this._canvas.width, this._canvas.height) && this._render();
  }
  setSegment(n, a) {
    this._dotLottieCore === null || b2._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), segment: u2([n, a], b2._wasmModule) });
  }
  setMode(n) {
    this._dotLottieCore === null || b2._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), mode: d2(n, b2._wasmModule) });
  }
  setRenderConfig(n) {
    let { devicePixelRatio: a, freezeOnOffscreen: s, ...v } = n;
    this._renderConfig = { ...this._renderConfig, ...v, devicePixelRatio: a || q(), freezeOnOffscreen: s ?? true }, P && this._canvas instanceof HTMLCanvasElement && (this._renderConfig.autoResize ? D.observe(this._canvas, this) : D.unobserve(this._canvas), this._renderConfig.freezeOnOffscreen ? O.observe(this._canvas, this) : (O.unobserve(this._canvas), this._isFrozen && this.unfreeze()));
  }
  loadAnimation(n) {
  ...
  markers() {
    ...
    if (n) {
      ...
      for (let s = 0; s < n.size(); s += 1) {
        let v = n.get(s);
        a.push({ name: v.name, time: v.time, duration: v.duration });
      }
      return a;
    }
    return [];
  ...
  setTheme(n) {
    if (this._dotLottieCore === null) return false;
    let a = this._dotLottieCore.setTheme(n);
  ...
  setThemeData(n) {
    if (this._dotLottieCore === null) return false;
    let a = this._dotLottieCore.setThemeData(n);
    return this._render(), a;
  }
  setSlots(n) {
  ...
  setLayout(n) {
    this._dotLottieCore === null || b2._wasmModule === null || this._dotLottieCore.setConfig({ ...this._dotLottieCore.config(), layout: l2(n, b2._wasmModule) });
  }
  setViewport(n, a, s, v) {
    return this._dotLottieCore === null ? false : this._dotLottieCore.setViewport(n, a, s, v);
  }
  static setWasmUrl(n) {
    G.setWasmUrl(n);
  }
  loadStateMachine(n) {
    return this._dotLottieCore?.stateMachineLoad(n) ?? false;
  }
  startStateMachine() {
    if (b2._wasmModule === null || this._dotLottieCore === null) return false;
    let n = b2._wasmModule.createDefaultOpenURL(), a = this._dotLottieCore.stateMachineStart(n);
    return a && this._setupStateMachineListeners(), a;
  }
  stopStateMachine() {
    let n = this._dotLottieCore?.stateMachineStop() ?? false;
    return n && this._cleanupStateMachineListeners(), n;
  }
  _getPointerPosition(n) {
    let a = this._canvas.getBoundingClientRect(), s = this._canvas.width / a.width, v = this._canvas.height / a.height, C = this._renderConfig.devicePixelRatio || window.devicePixelRatio || 1, B = (n.clientX - a.left) * s / C, z = (n.clientY - a.top) * v / C;
    return { x: B, y: z };
  }
  _onPointerUp(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this.postPointerUpEvent(a, s);
  }
  _onPointerDown(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this.postPointerDownEvent(a, s);
  }
  _onPointerMove(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this.postPointerMoveEvent(a, s);
  }
  _onPointerEnter(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this.postPointerEnterEvent(a, s);
  }
  _onPointerLeave(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this.postPointerExitEvent(a, s);
  }
  postPointerUpEvent(n, a) {
    return this._dotLottieCore?.stateMachinePostPointerUpEvent(n, a);
  }
  postPointerDownEvent(n, a) {
    return this._dotLottieCore?.stateMachinePostPointerDownEvent(n, a);
  }
  postPointerMoveEvent(n, a) {
    return this._dotLottieCore?.stateMachinePostPointerMoveEvent(n, a);
  }
  postPointerEnterEvent(n, a) {
    return this._dotLottieCore?.stateMachinePostPointerEnterEvent(n, a);
  }
  postPointerExitEvent(n, a) {
    return this._dotLottieCore?.stateMachinePostPointerExitEvent(n, a);
  }
  getStateMachineListeners() {
    if (!this._dotLottieCore) return [];
    let n = this._dotLottieCore.stateMachineFrameworkSetup(), a = [];
    for (let s = 0; s < n.size(); s += 1) a.push(n.get(s));
    return a;
  }
  ...
  _cleanupStateMachineListeners() {
    P && this._canvas instanceof HTMLCanvasElement && (this._canvas.removeEventListener("pointerup", this._pointerUpMethod), this._canvas.removeEventListener("pointerdown", this._pointerDownMethod), this._canvas.removeEventListener("pointermove", this._pointerMoveMethod), this._canvas.removeEventListener("pointerenter", this._pointerEnterMethod), this._canvas.removeEventListener("pointerleave", this._pointerExitMethod));
  }
  loadStateMachineData(n) {
    return this._dotLottieCore?.stateMachineLoadData(n) ?? false;
  }
  animationSize() {
...
var O1 = class {
  ...
  getWorker(n) {
    return this._workers.has(n) || this._workers.set(n, new K2()), this._workers.get(n);
  }
  ...
  sendMessage(n, a, s) {
    this.getWorker(n).postMessage(a, s || []);
  }
  terminateWorker(n) {
...
function e3(h2, n) {
  if (h2 instanceof HTMLCanvasElement) {
    let { height: a, width: s } = h2.getBoundingClientRect();
    if (a !== 0 && s !== 0) return { width: s * n, height: a * n };
  }
  return { width: h2.width, height: h2.height };
}
function t3() {
...
var j = class j2 {
  constructor(n) {
    ...
    m(this, "_pointerEnterMethod");
    m(this, "_pointerExitMethod");
    this._canvas = n.canvas, this._id = `dotlottie-${t3()}`;
    let a = n.workerId || "defaultWorker";
    this._worker = j2._workerManager.getWorker(a), j2._workerManager.assignAnimationToWorker(this._id, a), j2._wasmUrl && this._sendMessage("setWasmUrl", { url: j2._wasmUrl }), this._create({ ...n, renderConfig: { ...n.renderConfig, devicePixelRatio: n.renderConfig?.devicePixelRatio || q(), freezeOnOffscreen: n.renderConfig?.freezeOnOffscreen ?? true } }), this._worker.addEventListener("message", this._handleWorkerEvent.bind(this)), this._pointerUpMethod = this._onPointerUp.bind(this), this._pointerDownMethod = this._onPointerDown.bind(this), this._pointerMoveMethod = this._onPointerMove.bind(this), this._pointerEnterMethod = this._onPointerEnter.bind(this), this._pointerExitMethod = this._onPointerLeave.bind(this);
  }
  async _handleWorkerEvent(n) {
    let a = n.data;
    a.id || (a.method === "onLoad" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event), P && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && O.observe(this._canvas, this), this._dotLottieInstanceState.renderConfig.autoResize && D.observe(this._canvas, this))), a.method === "onComplete" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onDestroy" && a.result.instanceId === this._id && this._eventManager.dispatch(a.result.event), a.method === "onUnfreeze" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._dotLottieInstanceState.isFrozen = false, this._eventManager.dispatch(a.result.event)), a.method === "onFrame" && a.result.instanceId === this._id && (this._dotLottieInstanceState.currentFrame = a.result.event.currentFrame, this._eventManager.dispatch(a.result.event)), a.method === "onRender" && a.result.instanceId === this._id && this._eventManager.dispatch(a.result.event), a.method === "onFreeze" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onPause" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onPlay" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onStop" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onLoadError" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onRenderError" && a.result.instanceId === this._id && this._eventManager.dispatch(a.result.event), a.method === "onReady" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)), a.method === "onLoop" && a.result.instanceId === this._id && (await this._updateDotLottieInstanceState(), this._eventManager.dispatch(a.result.event)));
  }
  async _create(n) {
    let a;
    this._canvas instanceof HTMLCanvasElement ? a = this._canvas.transferControlToOffscreen() : a = this._canvas;
    let { instanceId: s } = await this._sendMessage("create", { instanceId: this._id, config: { ...n, canvas: a }, ...e3(this._canvas, n.renderConfig?.devicePixelRatio || q()) }, [a]);
  ...
  async play() {
    this._created && (await this._sendMessage("play", { instanceId: this._id }), await this._updateDotLottieInstanceState(), P && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !A1(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setTheme(n) {
    ...
    let a = this._sendMessage("setTheme", { instanceId: this._id, themeId: n });
  ...
  async resize() {
    if (!this._created) return;
    let { height: n, width: a } = e3(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || q());
    await this._sendMessage("resize", { height: n, instanceId: this._id, width: a }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage("destroy", { instanceId: this._id }), this._cleanupStateMachineListeners(), j2._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), P && this._canvas instanceof HTMLCanvasElement && (O.unobserve(this._canvas), D.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async setThemeData(n) {
    if (!this._created) return false;
    let a = await this._sendMessage("setThemeData", { instanceId: this._id, themeData: n });
    return await this._updateDotLottieInstanceState(), a;
  }
  async setViewport(n, a, s, v) {
    return this._created ? this._sendMessage("setViewport", { x: n, y: a, width: s, height: v, instanceId: this._id }) : false;
  }
  async animationSize() {
    return this._created ? this._sendMessage("animationSize", { instanceId: this._id }) : { height: 0, width: 0 };
  }
  async tween(n, a) {
    return this._created ? this._sendMessage("tween", { instanceId: this._id, frame: n, duration: a }) : false;
  }
  async tweenToMarker(n, a) {
    return this._created ? this._sendMessage("tweenToMarker", { instanceId: this._id, marker: n, duration: a }) : false;
  }
  async _sendMessage(n, a, s) {
    let v = { id: `dotlottie-request-${t3()}`, method: n, params: a };
    return this._worker.postMessage(v, s || []), new Promise((C, B) => {
      let z = (_1) => {
        let A = _1.data;
        A.id === v.id && (this._worker.removeEventListener("message", z), A.error ? B(new Error(`Failed to execute method ${n}: ${A.error}`)) : C(A.result));
      };
  ...
  async loadStateMachineData(n) {
    if (!this._created) return false;
    let a = await this._sendMessage("loadStateMachineData", { instanceId: this._id, stateMachineData: n });
    return await this._updateDotLottieInstanceState(), a;
  }
  ...
  _getPointerPosition(n) {
    let a = this._canvas.getBoundingClientRect(), s = this._canvas.width / a.width, v = this._canvas.height / a.height, C = this._dotLottieInstanceState.renderConfig.devicePixelRatio || window.devicePixelRatio || 1, B = (n.clientX - a.left) * s / C, z = (n.clientY - a.top) * v / C;
    return { x: B, y: z };
  }
  _onPointerUp(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this._sendMessage("postPointerUpEvent", { instanceId: this._id, x: a, y: s });
  }
  _onPointerDown(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this._sendMessage("postPointerDownEvent", { instanceId: this._id, x: a, y: s });
  }
  _onPointerMove(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this._sendMessage("postPointerMoveEvent", { instanceId: this._id, x: a, y: s });
  }
  _onPointerEnter(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this._sendMessage("postPointerEnterEvent", { instanceId: this._id, x: a, y: s });
  }
  _onPointerLeave(n) {
    let { x: a, y: s } = this._getPointerPosition(n);
    this._sendMessage("postPointerExitEvent", { instanceId: this._id, x: a, y: s });
  }
...
m(j, "_workerManager", new O1()), m(j, "_wasmUrl", "");
